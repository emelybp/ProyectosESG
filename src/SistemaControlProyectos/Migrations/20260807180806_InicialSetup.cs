    ...
    public partial class InicialSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BitacoraAuditorias", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CostosIngresos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CostosIngresos_Proyectos_ProyectoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estatus = table.Column<int>(type: "int", nullable: false),
                    EsHito = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CostosIngresos_Fecha",
                table: "CostosIngresos",
                column: "Fecha");

            migrationBuilder.CreateIndex(
                name: "IX_CostosIngresos_ProyectoId",
                table: "CostosIngresos",
                column: "ProyectoId");
